                    ...
                    <form id="signupForm" action="{{url('/doctor-registration')}}" method="post">
                        ...
                        <div class="singRow clearfix">
                            ...
                            <div class="box-in">
                                ...
                                <label for="first_name" class="error" id="last_name-error"></label>
                            </div>
                            ...
                            <div class="box-in">
                                ...
                                <select name="speciality" id="speciality" class="countryCode txtBox2" type="text" >
                                    <label for="speciality" class="error" id="speciality-error"></label>
                            ...
                            <div class="box-in1">
                                ...
                                <label for="district_phone_number" class="error" id="district_phone_number-error"></label>
                            </div>
                            ...
                            <div class="box-in1">
                                ...
                                <label for="zip_code" class="error" id="zip_code-error"></label>
