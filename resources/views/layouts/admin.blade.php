...
<head>
    ...
    <!-- bootstrap-wysiwyg -->
    <link href="{{url('public/admin/css/prettify.min.css')}}" rel="stylesheet">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <img src="{{url('public/admin/images/img.jpg')}}" alt="">John Doe
                ...
                <li role="presentation" class="dropdown">
                    ...
                    <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                        <li>
                            <a>
                                <span class="image"><img src="{{url('public/admin/images/img.jpg')}}" alt="Profile Image" /></span>
                        <span>
                ...
                <ul>
                    <li>
                        <a href="#" class="atch-thumb">
                            <img src="{{url('public/admin/images/inbox.png')}}" alt="img" />
                        </a>
...
<!-- bootstrap-wysiwyg -->
<script src="{{url('public/admin/js/bootstrap-wysiwyg.min.js')}}"></script>
<script src="{{url('public/admin/js/jquery.hotkeys.js')}}"></script>
<script src="{{url('public/admin/js/prettify.js')}}"></script>
