                ...
                <ul>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{url('/doctor/appointments?d='.$doctor_id)}}">Appointments</a></li>
                            <li><a href="{{url('/doctor/schedule?d='.$doctor_id)}}">My Schedule</a></li>
                            <li><a href="{{url('/doctor/settings?d='.$doctor_id)}}">Settings</a></li>
                            @endif
        ...
        <div class="container">
            <div class="row row-centered">
                <div class="col-md-3 tab_first">
                    <li><a href="{{url('doctor/appointments?d='.$doctor_id)}}" class="tab_title{{$tab1}}"><i class="fa fa-book padding"></i>Appointments</a></li>
                </div>
                <div class="col-md-3">
                    <li><a href="{{url('doctor/schedule?d='.$doctor_id)}}" class="tab_title{{$tab2}}"><i class="fa fa-calendar padding"></i>Schedule</a></li>
                </div>
                <div class="col-md-2 tab_last">
                    <li><a href="{{url('doctor/settings?d='.$doctor_id)}}" class="tab_title{{$tab3}}"><i class="fa fa-asterisk padding"></i>Settings</a></li>
                </div>
            </div>
            <hr>
        </div>
